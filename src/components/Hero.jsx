...
import resumeRu from '../assets/Timur_CV_ru.pdf'
import resumeEn from '../assets/Timur_CV_en.pdf'

const Hero = () => {
  const { t, language } = useTranslation()
  const resumePDF = language === 'ru' ? resumeRu : resumeEn
      ...
      <div className="hero-content">
        <div className="hero-text">
          ...
          <div className="hero-buttons">
            ...
            <a
              href={resumePDF}
              download={language === 'ru' ? 'Timur_CV_ru.pdf' : 'Timur_CV_en.pdf'}
          ...
          <div className="hero-social">
            ...
            <a href="https://www.linkedin.com/in/timurzheksimbaev" target="_blank" rel="noopener noreferrer" className="social-link">
